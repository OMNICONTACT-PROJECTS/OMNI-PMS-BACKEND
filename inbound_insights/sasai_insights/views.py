from .serializers import (
    SasaiInsightsSerializer,
    SasaiInsightsRetrieveSerializer,
    SasaiInsightsUpdateSerializer,
)
...
from .resources import SasaiInsightsResource
...
class CreateSasaiInsightsView(CreateAPIView):
    permission_classes = []
    serializer_class = SasaiInsightsSerializer
    ...
    def create(self, request, *args, **kwargs):
        ...
        try:
            ...
            if serializer.is_valid():
                ...
                data = {
                    "message": "Sasai Insights created successfully",
            ...
            return Response(
                {
                    "message": "Failed to create Sasai insights, Validation error occurred.",
            ...
            return Response(
                {
                    "message": "Failed to create Sasai Insights. Exception error occurred",
                    "error": str(e),
                },
                status=status.HTTP_400_BAD_REQUEST,
            )
...
class GetAllSasaiInsights(ListAPIView):
    permission_classes = []
    serializer_class = SasaiInsightsRetrieveSerializer
    queryset = SasaiInsights.objects.all()


class SasaiInsightsReadDestroyView(RetrieveDestroyAPIView):
    permission_classes = []
    serializer_class = SasaiInsightsRetrieveSerializer
    queryset = SasaiInsights.objects.all()


class SasaiInsightsUpdateView(UpdateAPIView):
    permission_classes = []
    serializer_class = SasaiInsightsUpdateSerializer
    queryset = SasaiInsights.objects.all()


class GetSasaiInsightsByUserId(GenericAPIView):
    permission_classes = []
    serializer_class = SasaiInsightsRetrieveSerializer
    queryset = SasaiInsights.objects.all()
    ...
    def get(self, request, user_id, *args, **kwargs):
        try:
            ...
            sasai_insights = self.queryset.filter(user_id=user_id).order_by(
                "-date_created"
            )
...
class GetSasaiInsightsForHVCAgentsByOrganisationId(GenericAPIView):
    permission_classes = []
    serializer_class = SasaiInsightsRetrieveSerializer
    queryset = SasaiInsights.objects.all()
    ...
    def get(self, request, organisation_id, *args, **kwargs):
        try:
            ...
            sasai_insights = self.queryset.filter(agent_type="HVC").order_by(
                "-date_created"
            )
            serializer = self.serializer_class(sasai_insights, many=True)
            return Response(data=serializer.data, status=status.HTTP_200_OK)
...
class GetSasaiInsightsForLVCAgentsByOrganisationId(GenericAPIView):
    permission_classes = []
    serializer_class = SasaiInsightsRetrieveSerializer
    queryset = SasaiInsights.objects.all()
    ...
    def get(self, request, organisation_id, *args, **kwargs):
        try:
            ...
            sasai_insights = self.queryset.filter(agent_type="LVC").order_by(
                "-date_created"
            )
            serializer = self.serializer_class(sasai_insights, many=True)
            return Response(data=serializer.data, status=status.HTTP_200_OK)
...
class GetSasaiInsightsByDateAndOrganisationId(GenericAPIView):
    permission_classes = []
    serializer_class = SasaiInsightsRetrieveSerializer
    queryset = SasaiInsights.objects.all()
...
class BulkUploadSasaiInsightsDataView(GenericAPIView):
    permission_classes = []
    ...
    def post(self, request, *args, **kwargs):
        try:
            ...
            try:
                ...
                sasai_insights_resource = SasaiInsightsResource()
                df = None
                ...
                try:
                    result = sasai_insights_resource.import_data(
                    ...
                    return Response(
                        {
                            "message": "Failed to upload Sasai insights data, an error occurred",
                            "error": error_message,
                        },
                        status=status.HTTP_400_BAD_REQUEST,
                    )
                ...
                if not result.has_errors():
                    sasai_insights_resource.import_data(dataset, dry_run=False)
                    try:
                        ...
                        pass
                    return Response(
                        {"message": "Sasai Insights Data Uploaded Successfully."},
...
class GetSasaiInsightsUploadedFilesView(GenericAPIView):
    permission_classes = []
    serializer_class = CampaignInsightFileSerializer
    ...
    def get(self, request, organisation_id, campaign_name, *args, **kwargs):
        try:
            ...
            sasai_insights_files = self.queryset.filter(
...
class UploadSasaiInsightsBulkUploadTemplate(GenericAPIView):
    permission_classes = []
    parser_classes = [MultiPartParser, FormParser]
    serializer_class = CampaignInsightFileSerializer
    queryset = CampaignInsightFile.objects.all()
    ...
    def post(self, request, *args, **kwargs):
        ...
        return Response(
            {
                "message": "Failed to upload sasai insight template",
                "error": serializer.errors,
            },
            status=status.HTTP_404_NOT_FOUND,
        )
...
class GetSasaiInsightsBulkUploadTemplate(GenericAPIView):
    permission_classes = []
...
####################################################
class NewGetAllSasaiInsightsStatisticsWithWeekView(GenericAPIView):
    permission_classes = []
    serializer_class = SasaiInsightsRetrieveSerializer
    queryset = SasaiInsights.objects.all()
