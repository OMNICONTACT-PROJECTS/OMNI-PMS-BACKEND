    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(blank=True, choices=[('DEV', 'DEV'), ('SUPERUSER', 'SUPERUSER'), ('ADMIN', 'ADMIN'), ('SUBSCRIBER', 'SUBSCRIBER')], max_length=25, null=True)),
                ...
                ('user_status', models.CharField(blank=True, choices=[('ACTIVE', 'ACTIVE'), ('ON_LEAVE', 'ON_LEAVE'), ('ON_PAUSE', 'ON_PAUSE'), ('BUFFER', 'BUFFER'), ('SECONDMENT', 'SECONDMENT'), ('TERMINATED', 'TERMINATED')], max_length=150, null=True)),
                ('account_status', models.CharField(blank=True, choices=[('ACTIVE', 'ACTIVE'), ('INACTIVE', 'INACTIVE')], max_length=150, null=True)),
                ('contract_type', models.CharField(blank=True, choices=[('FIXED', 'FIXED'), ('MNO', 'MNO'), ('BUFFER', 'BUFFER')], max_length=150, null=True)),
                ('contract_tenure', models.CharField(blank=True, max_length=20, null=True)),
